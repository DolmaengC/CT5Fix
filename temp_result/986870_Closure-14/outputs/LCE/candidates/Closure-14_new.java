      ...
      case Token.TRY:
        ...
        // CATCH block.
          ...
          if (NodeUtil.hasFinally(parent)) { // and have FINALLY block.
            ...
            return computeFollowNode(fromNode, parent, cfa);
 }// If we are coming out of the FINALLY block...} else if (parent.getLastChild() == node){if (cfa!= null) {for (Node finallyNode : cfa.finallyMap.get(parent)) {cfa.createEdge(fromNode, Branch.UNCOND, finallyNode);}}else {return computeFollowNode(fromNode, parent, cfa);}} else {return computeFollowNode(fromNode, parent, cfa);}}
