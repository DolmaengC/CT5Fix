...
final class ControlFlowAnalysis implements Callback, CompilerPass {
 ...
 if (cfa. finallyMap.get(fromNode)) {cfa.createEdge(toNode, Branch.COND, finallyNode);}} else {cfa.createEdge(fromNode, Branch.COND, finallyNode);}} else {cfa.createEdge(fromNode, Branch.UNCOND, finallyNode);}} }          return computeFollowNode(fromNode, parent, cfa);
        }
    }
